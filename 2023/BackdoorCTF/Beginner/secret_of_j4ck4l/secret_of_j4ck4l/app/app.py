...
def useless(file_param):
    ...
    print(f"file_param1: {file_param1}", file=sys.stderr)
    file_param2 = another_useless_function(file_param1)
    print(f"file_param2: {file_param2}", file=sys.stderr)
    file_param3 = ignore_it(file_param2)
    print(f"file_param3: {file_param3}", file=sys.stderr)
    file_param4 = another_useless_function(file_param3)
    print(f"file_param4: {file_param4}", file=sys.stderr)
...
def read_file(file_param=None):
    ...
    print(file_param, file=sys.stderr)
    sys.stdout.flush()
    sys.stderr.flush()
